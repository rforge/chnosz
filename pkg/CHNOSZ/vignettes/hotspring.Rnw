...
diagram(a, fill=NULL, names=1:5, normalize=TRUE, format.names=FALSE)
...
to knitr.
\item 2016-12-21 As superseded methionine sidechain group has been removed
from OBIGT-2.csv, use \texttt{mod.obigt()} to reproduce the calculations.
\end{itemize}
