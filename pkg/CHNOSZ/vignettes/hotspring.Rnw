...
for the methionine sidechain group used in the 2011 paper \citep{DS11}
was updated in CHNOSZ\_0.9-9 \citep{LD12}, but the older dataset
is still available using \texttt{add.obigt()}.
